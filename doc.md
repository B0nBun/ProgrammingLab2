...
# Вывод
Во время выполнения лабораторной работы я изучил основные концепции парадигмы **"Объектно Ориентированyого Программирования"**, узнал и опробовал некоторые новые возможности `Java`, такие как ключевое слово `final`, наследование, модификаторы доступа, переопределение членов класса. А также ознакомился с системой пакетов и импортов.
